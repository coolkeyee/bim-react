...
export default function StatusPanel(props: StatusPanelProps) {
  ...
  const [is_images_visible, set_is_images_visible] = React.useState(false);
  const scene_button = is_scene_visible ? '隐藏场景' : '显示场景';
  const cameras_button = is_images_visible ? '隐藏训练图片' : '显示训练图片';
